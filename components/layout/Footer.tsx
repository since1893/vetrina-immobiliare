      ...
      <footer className="bg-white border-t border-gray-200 py-6 mt-auto">
        <Container>
          <div className="text-center text-sm text-gray-600">
            <p>&copy; {currentYear} Vetrina Immobiliare. Tutti i diritti riservati.</p>
            <div className="mt-2 space-x-4">
              <Link href="/privacy" className="hover:text-gray-900">Privacy Policy</Link>
              <Link href="/termini" className="hover:text-gray-900">Termini di Servizio</Link>
      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              Piattaforma gratuita per annunci immobiliari. Pubblica e cerca casa facilmente.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-400">
              &copy; {currentYear} Vetrina Immobiliare. Tutti i diritti riservati.
            </p>
